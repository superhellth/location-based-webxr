...
genuine device jitter). Click **Drop Waypoint** as the position moves; edit
a waypoint's radii or attach a file to its model/sprite/audio slot; click
**Export** to pack a real `tour.zip` via component 5's `packTour` — load it
in the cloud-loader or ar-scene demo to see it play back.

## Layout

| Path              | What lives here                                                                                                                                                                    |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `demo.ts`         | Standalone demo entry: live/replay position source toggle, a minimal store over the real `authoringReducer`, and export → `packTour`.                                              |
